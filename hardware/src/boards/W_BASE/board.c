...
//    GpioInit( &DebugPin1, DEBUG_PIN1, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
//    GpioInit( &DebugPin2, DEBUG_PIN2, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);


//    GpioWrite( &Led1, 0 );
//    GpioWrite( &DebugPin1, 0 );
//    GpioWrite( &DebugPin2, 0 );
}
